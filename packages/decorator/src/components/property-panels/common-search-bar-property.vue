    ...
    <div class="common-search-bar-property">
        <el-tabs v-model="activeName" stretch>
            ...
            <el-tab-pane label="搜索按钮" name="button">
                <common-button-property-component :property="property.button"
                                                  @propertyChange="onPropertyChange('button','',$event)"></common-button-property-component>
            </el-tab-pane>
        </el-tabs>
    </div>
</template>
...
<script>
    export default {
        name: "common-search-bar-property",
        props: {
            property: {
                type: Object
            }
